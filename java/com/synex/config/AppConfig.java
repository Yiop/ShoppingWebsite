...
public class AppConfig {
	...
	public DataSource dataSource(){
		...
		dataSource.setUrl("jdbc:mysql://localhost:3306/shoppingwebsite?serverTimezone=UTC");
	...
	public LocalSessionFactoryBean sessionFactory(){
		...
		sessionFactory.setAnnotatedClasses(new Class<?>[] {NewCategory.class, NewCategoryDetail.class, NewProduct.class, NewReview.class, NewUser.class, NewOrder.class, NewCart.class});
